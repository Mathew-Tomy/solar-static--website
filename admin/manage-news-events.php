...
include("connection.php");
		$sqlskr=$db->query("select * from tbl_news_events order by news_id desc");
?>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover tbl_repeat" >
												...
												while($rows=$sqlskr->fetch_assoc())
												{
													...
													<tr >
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" class="ace" name="del" value="<?=$rows['news_id']?>"/>
																<span class="lbl"></span>
															</label>
														</td>
													...
													<td><?php if($rows['news_img']!=""){?>
														  <a href="#" class="catimg"  style="outline:none;marign-right:20px;">View
                <span><img src="<?=$rows['news_img'];?>" style="outline:none" height="50px" width="50px"  /></span></a>
													<? }?></td>
														...
														<td>
															...
															<a class="green" href="edit-news-events.php?tid=<?=$rows['news_id'];?>">
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a href="#" onClick='dele("<?php echo "delete.php?news_id=$news_id";?>")' class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
																					<i class="ace-icon fa fa-trash-o bigger-120"></i>
																				</span>
																			</a>
