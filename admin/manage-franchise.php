...
$sqlkr = $db->query("SELECT  * FROM " .TABLE ." ORDER BY franchise_id desc ");
?>
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover tbl_repeat" >
												...
												$fr_id=$rows['franchise_id'];?>
													<tr >
														<td class="center">
															<label class="pos-rel">
																<input type="checkbox" class="ace" name="del" value="<?=$rows['franchise_id']?>"/>
																<span class="lbl"></span>
															</label>
														</td>
														...
														<td>
															<?=$rows['franchise_address'];?>
															
														</td>
														<td>
															<?=$rows['franchise_phone'];?>
															
														</td>
														<td>
															<?=$rows['franchise_email'];?>
														...
														<td>
															...
															<a class="green" href="edit-franchise.php?fid=<?=$rows['franchise_id'];?>">
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a href="#" onClick='dele("<?php echo "delete.php?fr_id=$fr_id";?>")' class="tooltip-error" data-rel="tooltip" title="Delete">
																				<span class="red">
																					<i class="ace-icon fa fa-trash-o bigger-120"></i>
																				</span>
																			</a>
